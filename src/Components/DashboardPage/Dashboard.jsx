...
export const Dashboard = () => {
  ...
  const [showOurServicesModal, setShowOurServicesModal] = useState(false);
  ...
  return (
    <>
      ...
      ></div>
      <div class="d-flex flex-column flex-root app-root" id="nit_app_root">
        <div class="app-page flex-column flex-column-fluid" id="nit_app_page">
                ...
                <div className="app-navbar align-items-center flex-shrink-0">
                  ...
                  <div className="app-navbar-item ms-2 ms-lg-4">
                    <a
                      ...
                      data-nit-menu-placement="bottom-end"
                    >
                      <i className="nit-dt nit-night-day theme-light-show fs-2qx">
                        <span className="path1"></span>
                        <span className="path2"></span>
                        <span className="path3"></span>
                        <span className="path4"></span>
                      ...
                      <i className="nit-dt nit-moon theme-dark-show fs-1">
                        <span className="path1"></span>
                        <span className="path2"></span>
                      </i>
                    </a>
    ...
    <span className="path4"></span>
                  ...
                  >
                    <div
                      ...
                      data-nit-menu-placement="bottom-end"
                    >
                      <img src={userProfile} className="rounded-3" alt="user" />
                    </div>
                    ...
                    >
                      ...
                      <div className="menu-item px-5">
                        <a href="activity-log.html" className="menu-link px-5">
                          My Activity Log
                        </a>
                      </div>
            ...
            >
              ...
              <div className="app-sidebar-toolbar d-flex flex-stack py-6 px-8">
                ...
                >
                  ...
                  <option value="2">New Case</option>
                  <option value="3">Add Fund</option>
                              ...
                              >
                                ...
                                <div className="d-flex align-items-center mb-6">
                                  ...
                                  <div className="flex-grow-1 me-5">
                                    ...
                                    <div className="text-gray-700 fw-semibold fs-6">
                                      Neural IT Team may not be available today
                                    </div>
                                    <div className="text-gray-500 fw-semibold fs-7">
                                      Visit Holiday
                                      <a
        ...
        <div id="nit_scrolltop" className="scrolltop" data-nit-scrolltop="true">

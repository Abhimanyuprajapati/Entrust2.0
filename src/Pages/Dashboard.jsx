...
import { Approvals } from "../dashboardPages/Approvals";
...
export const Dashboard = () => {
  ...
  const handleOverviewClick = () => navigate("/dashboard");
  const handleInvoicesClick = () => navigate("/dashboard/invoices");
  const handleApprovalsClick = () => navigate("/dashboard/approvals");
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="app-sidebar-toolbar d-flex flex-stack py-4 px-8">
                  <Box sx={{ minWidth: 190 }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {isSubMenuVisible && (
                        <div>
                          <div className="menu-item" onClick={handleCaseTrackerClick}>
                            <a className="menu-link">
                              <span className="menu-icon">
                          ...
                          <div className="menu-item" onClick={handleProjectTrackerClick}>
                            <a className="menu-link">
                              <span className="menu-icon">
                                <i className="nit-dt nit-rocket fs-2">
                                  <span className="path1"></span>
                ...
                <div className="app-sidebar-user d-flex flex-stack py-2 px-8">
                  <div className="d-flex me-5">
                    ...
                    <div className="me-2">
                      <a className="app-sidebar-username text-gray-800 text-hover-primary fs-6 fw-semibold lh-0">
                        John Lambert
                      </a>
                            ...
                            <div className="" data-nit-search-element="main">
                              ...
                              >
                                ...
                                <div className="mb-5">
                                  ...
                                  >
                                    <option>Within the next</option>
                                    <option>Within the last</option>
                      ...
                      <div className="app-navbar-item ms-2 ms-lg-4">
                        ...
                        >
                          ...
                          <div className="row g-0">
                            ...
                            <div className="col-6">
                              <a className="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                          ...
                          <div className="row g-0 p-3">
                            <div className="d-flex flex-stack py-4">
                              <div className="d-flex align-items-center me-2">
                                ...
                                <a className="text-gray-800 text-hover-primary fw-semibold">
                                  New Case Submitted
                                </a>
                              </div>

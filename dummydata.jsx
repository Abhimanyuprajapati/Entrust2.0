              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className={`menu-item menu-accordion ${isSubMenuVisible ? "show" : ""
                        }`}
                    >
                  ...
                  >
                    ...
                    <div className="app-navbar align-items-center flex-shrink-0">
                      ...
                      <div className="app-navbar-item ms-2 ms-lg-4">
                        ...
                        >
                          <i
                            className={`nit-dt nit-night-day theme-light-show fs-2qx ${themeMode === "light" ? "active" : ""
                              }`}
                          >
                            <span className="path1"></span>
                            <span className="path2"></span>
                          ...
                          <i
                            className={`nit-dt nit-moon theme-dark-show fs-1 ${themeMode === "dark" ? "active" : ""
                              }`}
                          >
                            <span className="path1"></span>
                            <span className="path2"></span>
...
export const Dashboard = () => {
  ...
  const ProjectTracker = () => {
    navigate1("/projectTracker");
  };


  const [age, setAge] = React.useState('Services');
          ...
          >
            ...
            >
              ...
              >
                ...
                <div class="app-sidebar-toolbar d-flex flex-stack py-4 px-8">
                  <Box sx={{ minWidth: 190 }}>
                    <FormControl sx={{ m: 1, minWidth: 190 }} size="small">
                      ...
                      >
                        <MenuItem value={"Services"}>Select Services</MenuItem>
                        <MenuItem value={"Upload Files"}>Upload Files</MenuItem>
                        <MenuItem value={"New Case"}>New Case</MenuItem>
                        <MenuItem value={"Add Fund"}>Add Fund</MenuItem>
                        <MenuItem value={"Manage Cards"}>Manage Cards</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
                  ...
                  <a
                    ...
                    class="btn btn-icon btn-custom fw-bold flex-shrink-0 ms-3"
                    data-bs-toggle="modal"
                    data-bs-target="#modal_quick_action_upload"
                  >
                    <i class="nit-dt nit-plus fs-1"></i>
                  </a>
                </div>

                <div className="separator"></div>
                {/* this is navbar to redirect the pages components */}
                <div
                  className="app-sidebar-menu hover-scroll-y my-5 my-lg-5 mx-3"
                  id="nit_app_sidebar_menu_wrapper"
                  data-nit-scroll="true"
                ...
                >
                  <div
                    ...
                    data-nit-menu="true"
                  >
                    <div className={`menu-item menu-accordion ${isDashboardVisible ? "show" : ""}`}>
                      <span className="menu-link" onClick={toggleDashboardMenu}>
                        <span className="menu-icon">
                          <i className="nit-dt nit-chart-pie-3 fs-2"></i>
                        </span>
                        <span className="menu-title">Dashboards</span>
                        <span className="menu-arrow"></span>
                      </span>
                      ...
                      {isDashboardVisible && (
                        <div>
                          <div className="menu-item" onClick={handleOverviewClick}>
                            <a className="menu-link">
                              <span className="menu-icon">
                                <i className="nit-dt nit-chart fs-2"></i>
                              </span>
                          ...
                          <div className="menu-item" onClick={handleInvoicesClick}>
                            <a className="menu-link">
                              <span className="menu-icon">
                                <i className="nit-dt nit-bill fs-2"></i>
                              </span>
                              <span className="menu-title">Invoices</span>
                            </a>
                          </div>
                          <div className="menu-item" onClick={handleApprovalsClick}>
                            <a className="menu-link">
                              <span className="menu-icon">
                                <i className="nit-dt nit-shield-tick fs-2"></i>
                              </span>
                              <span className="menu-title">Approvals</span>
                            </a>
                          </div>
              ...
              <div>    {/* this is added by me  div*/}
                {/* this is header bar is same for all pages*/}
                <div id="nit_app_header" className="app-header">
                  <div
                    className="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    id="nit_app_header_container"
                ...
                {/* this is main contents  pages*/}

                {/* viewdashboard components */}
                <ViewDashboard />
                <CaseTracker />
              </div>
...
// import Protected from '../services/Protected';
// import { CaseTracker } from './dashboardPages/CaseTracker';
// import { ProjectTracker } from './dashboardPages/ProjectTracker';
// import { SingleCase } from './components/casetracker/SingleCase';
// import { ProjectDetails } from './components/projecttracker/ProjectDetails';



{/* <Route path="/dashboard/caseTracker" element={<CaseTracker/>}/>
<Route path="/dashboard/projectTracker" element={<ProjectTracker/>}/>
<Route path="/singlecase" element={<SingleCase/>}/>
<Route path="/project/:projectId" element={<ProjectDetails />} /> */}
          ...
          >
            ...
            >
              ...
              <div>    {/* this is added by me  div*/}
                ...
                {/* viewdashboard components */}
                {/* this part will be dynamic based on on click i have to show this  */}
                {/* by default i am showing      <ViewDashboard /> on click this handleOverviewClick function */}

                {
                  // this part will be based on routes  by default i am showing this 
                  <ViewDashboard />
                }
                ...
                <Routes>
                  ...
                  <Route path="/deliveredcases" element={<DeliveredCases />} />
                  <Route path="/financialactivity" element={<FinancialActivity />} />
